...
export default class DetailsModal extends React.Component {
  render() {
    let link = this.props.link ? <a className="button is-primary is-pulled-right"
      rel="noopener noreferrer" target="_blank" href={this.props.link}>
      {this.props.link}
    </a> : null
    ...
    return <div className={`banner ${this.props.active ? 'modal is-active' : 'modal'}`}>
      ...
      <div className="modal-content" style={{ width: '80%' }}>
        ...
        <div className="notification is-info is-light">
          ...
          <h5 className="title is-5">{this.props.title} {link}</h5>
